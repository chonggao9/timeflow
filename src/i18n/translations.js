...
export const translations = {
  zh: {
    ...
    'home.locAlertBody': '无法获取定位。请确认手机「位置信息」开关已开，并到开阔处（户外/窗边）后再试。\n也可点时间轴上的地点名手动修改。',
  ...
  en: {
    ...
    'home.locAlertTitle': "Couldn't locate you",
    'home.locAlertBody': "Couldn't get your location. Make sure your phone's Location switch is on and try in an open area (outdoors / near a window).\nYou can also tap a place name on the timeline to edit.",
