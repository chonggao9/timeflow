...
const CONTENT_ZH = {
  ...
  intro: 'TimeFlow（时光流）尊重并保护你的个人信息。本政策依据《中华人民共和国个人信息保护法》等法律法规制定，请在使用前仔细阅读、充分理解。',
  sections: [
    ...
    ['七、未成年人保护', '本应用不面向未满 14 周岁的未成年人收集个人信息。如你未满 14 周岁，请在监护人指导下使用，并由监护人阅读本政策。'],
...
const CONTENT_EN = {
  ...
  intro: 'TimeFlow respects and protects your personal information. This policy is drafted in accordance with the PRC Personal Information Protection Law and other applicable laws. Please read and fully understand it before use.',
  sections: [
    ...
    ['7. Minors', 'This app does not collect personal information from minors under 14. If you are under 14, please use it under the guidance of a guardian, who should read this policy.'],
